function updateClock() {
  ...
  (function () {
    ...
    function updateTime() {
      ...
      localStorage.hours = hour;
  
      document.getElementById("hours_stopwatch").innerText = localStorage.hours;
      document.getElementById("minutes_stopwatch").innerText =
        localStorage.minutes;
      document.getElementById("seconds_stopwatch").innerText =
        localStorage.seconds;
      document.getElementById("milliseconds_stopwatch").innerText =
        localStorage.milliSeconds;
